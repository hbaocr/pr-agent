        ...
        if (get_settings().pr_reviewer.enable_review_labels_security or
            ...
            try:
                ...
                if get_settings().pr_reviewer.enable_review_labels_security and get_settings().pr_reviewer.require_security_review:
                    security_concerns = data['review'].get('security_concerns', 'no')
                    security_concerns_str = str(security_concerns).lower()
                    security_concerns_bool = 'yes' in security_concerns_str or 'true' in security_concerns_str
